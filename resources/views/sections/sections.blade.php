...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الاعدادات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الاقساط</span>
						</div>
					</div>
		...
		<div class="modal-content modal-content-demo">
			...
			<form action="{{route('sections.store')}}" method="post">
				...
				<div class="form-group">
					<label for="exampleFormControlTextarea1">اسم القسم</label>
				...
				<div class="form-group">
					<label for="exampleFormControlTextarea1">ملاخظات</label>
					<textarea class="form-control" id="description" name="description" rows="3"></textarea>
				</div>


				<div class="modal-footer">
					<button class="btn ripple btn-primary"  >تاكيد</button>

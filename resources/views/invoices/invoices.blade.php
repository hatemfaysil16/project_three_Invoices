		...
		<div class="col-xl-12">
			<div class="card mg-b-20">
				<div class="card-header pb-0">
						...
						<a href="invoices/create" class="model-effect btn btn-sm btn-primary">
							<i class="fas fa-plus">اضافة الفواتير</i></a>
						</a>
						...
						<table id="example1" class="table key-buttons text-md-nowrap">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{$item->due_date}} </td>
									<td>{{$item->product}} </td>
									<td><a href="{{ route('deletlis.edit',$item->id) }}">{{$item->section->section_name}}</a> </td>
									<td>{{$item->Discount}}</td>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu tx-13">
													...
													<a class="dropdown-item"
													href="{{url('Status_show',$item->id )}}"><i
